class Monstruo {
    constructor(nombre, habitat, tipo, descripcion, combate, icono) {
        this.nombre = nombre;
...
function Overlay(monstruo) {
    ...
    if (overlayAbierto) {
        ...
        const iconoElemento = document.getElementById('iconoMonstruo');
        ...
        iconoElemento.innerHTML = monstruos[monstruo - 1].icono;
